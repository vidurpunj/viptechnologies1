                ...
                >
                    {blogData.map((item, index) => (
                        <div className="item" key={index}>
                            {/* Blog Card */}
                            <div className="card bg-transparent border-dark text-center">
                                ...
                                <div className="card-body pt-5">
                                    <Link className="d-inline-block  text-primary mb-2" to="/">
                                        {item.category}
                                    </Link>
                                    <h2 className="h5 font-weight-medium">
                                        <Link className="link-title text-white" to="/blog-single" onClick={() => {
